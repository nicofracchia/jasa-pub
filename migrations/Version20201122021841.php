 ...
 */
final class Version20201122021841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caja (id INT AUTO_INCREMENT NOT NULL, usuario_apertura_id INT DEFAULT NULL, usuario_cierre_id INT DEFAULT NULL, inicio DATETIME NOT NULL, cierre DATETIME DEFAULT NULL, saldo_inicial DOUBLE PRECISION NOT NULL, saldo_estimado DOUBLE PRECISION DEFAULT NULL, saldo_final DOUBLE PRECISION DEFAULT NULL, estado TINYINT(1) NOT NULL, INDEX IDX_E465F405167E8AA5 (usuario_apertura_id), INDEX IDX_E465F4054CF69F79 (usuario_cierre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorias (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, id_padre INT NOT NULL, final INT NOT NULL, grupo_id VARCHAR(255) NOT NULL, habilitado SMALLINT NOT NULL, eliminado SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorias_productos (id INT AUTO_INCREMENT NOT NULL, producto_id INT NOT NULL, categoria_id INT NOT NULL, INDEX IDX_2AA1DD387645698E (producto_id), INDEX IDX_2AA1DD383397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE clientes (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellido VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, dni VARCHAR(255) NOT NULL, telefono VARCHAR(255) DEFAULT NULL, direccion VARCHAR(255) DEFAULT NULL, habilitado TINYINT(1) NOT NULL, eliminado TINYINT(1) NOT NULL, cuit INT DEFAULT NULL, razon_social VARCHAR(255) DEFAULT NULL, cuenta_corriente TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compras (id INT AUTO_INCREMENT NOT NULL, proveedor_id INT DEFAULT NULL, almacen_id INT DEFAULT NULL, creador_id INT NOT NULL, fecha DATETIME NOT NULL, precio DOUBLE PRECISION DEFAULT NULL, estado VARCHAR(255) NOT NULL, recepcion DATETIME DEFAULT NULL, INDEX IDX_3692E1B7CB305D73 (proveedor_id), INDEX IDX_3692E1B79C9C9E68 (almacen_id), INDEX IDX_3692E1B762F40C3D (creador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE compras_productos (id INT AUTO_INCREMENT NOT NULL, compra_id INT NOT NULL, producto_id INT NOT NULL, cantidad INT NOT NULL, INDEX IDX_DC9917F7F2E704D7 (compra_id), INDEX IDX_DC9917F77645698E (producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cotizaciones (id INT AUTO_INCREMENT NOT NULL, id_cliente_id INT DEFAULT NULL, creador_id INT DEFAULT NULL, almacen_id INT DEFAULT NULL, fecha DATETIME NOT NULL, estado VARCHAR(255) NOT NULL, hasta DATE DEFAULT NULL, descuento DOUBLE PRECISION DEFAULT NULL, mantener_precio TINYINT(1) NOT NULL, INDEX IDX_12CE14AE7BF9CE86 (id_cliente_id), INDEX IDX_12CE14AE62F40C3D (creador_id), INDEX IDX_12CE14AE9C9C9E68 (almacen_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cotizaciones_productos (id INT AUTO_INCREMENT NOT NULL, id_cotizacion_id INT NOT NULL, id_producto_id INT NOT NULL, cantidad INT NOT NULL, precio_actual DOUBLE PRECISION NOT NULL, costo_actual DOUBLE PRECISION NOT NULL, reserva_mercaderia TINYINT(1) NOT NULL, INDEX IDX_E238C0068E5841CF (id_cotizacion_id), INDEX IDX_E238C0066E57A479 (id_producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE movimientos_caja (id INT AUTO_INCREMENT NOT NULL, caja_id INT DEFAULT NULL, creador_id INT DEFAULT NULL, fecha DATETIME NOT NULL, movimiento VARCHAR(255) NOT NULL, tipo_movimiento TINYINT(1) NOT NULL, monto DOUBLE PRECISION NOT NULL, observaciones VARCHAR(255) DEFAULT NULL, INDEX IDX_C8F6D5E32D82B651 (caja_id), INDEX IDX_C8F6D5E362F40C3D (creador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE productos (id INT AUTO_INCREMENT NOT NULL, id_unidad_medida_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, codigo_barras VARCHAR(255) DEFAULT NULL, costo DOUBLE PRECISION NOT NULL, porcentaje_costo DOUBLE PRECISION NOT NULL, precio_final DOUBLE PRECISION NOT NULL, descripcion LONGTEXT DEFAULT NULL, habilitado TINYINT(1) NOT NULL, eliminado TINYINT(1) NOT NULL, imagen VARCHAR(255) DEFAULT NULL, stock_actual INT NOT NULL, stock_minimo INT NOT NULL, diametro DOUBLE PRECISION DEFAULT NULL, largo DOUBLE PRECISION DEFAULT NULL, ancho DOUBLE PRECISION DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, material VARCHAR(255) DEFAULT NULL, utilidad LONGTEXT DEFAULT NULL, presentacion LONGTEXT DEFAULT NULL, iva DOUBLE PRECISION DEFAULT NULL, INDEX IDX_767490E6E16A5625 (id_unidad_medida_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE unidades_medida (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, nombre_padre VARCHAR(255) NOT NULL, corto VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ventas (id INT AUTO_INCREMENT NOT NULL, cliente_id INT DEFAULT NULL, almacen_id INT NOT NULL, creador_id INT NOT NULL, fecha DATETIME NOT NULL, estado VARCHAR(255) NOT NULL, precio_final DOUBLE PRECISION NOT NULL, INDEX IDX_808D9EDE734E51 (cliente_id), INDEX IDX_808D9E9C9C9E68 (almacen_id), INDEX IDX_808D9E62F40C3D (creador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ventas_pagos (id INT AUTO_INCREMENT NOT NULL, medio_pago_id INT NOT NULL, venta_id INT NOT NULL, fecha DATETIME NOT NULL, monto DOUBLE PRECISION NOT NULL, comprobante VARCHAR(255) DEFAULT NULL, url_comprobante VARCHAR(255) DEFAULT NULL, observaciones VARCHAR(255) DEFAULT NULL, interes DOUBLE PRECISION NOT NULL, nota_venta TINYINT(1) NOT NULL, INDEX IDX_D3E05448CAEEDE5B (medio_pago_id), INDEX IDX_D3E05448F2A5805D (venta_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ventas_pagos_detalle (id INT AUTO_INCREMENT NOT NULL, pago_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, valor VARCHAR(255) NOT NULL, INDEX IDX_18297BA63FB8380 (pago_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ventas_productos (id INT AUTO_INCREMENT NOT NULL, venta_id INT NOT NULL, producto_id INT NOT NULL, cantidad INT NOT NULL, costo DOUBLE PRECISION NOT NULL, precio DOUBLE PRECISION NOT NULL, INDEX IDX_20ABEB63F2A5805D (venta_id), INDEX IDX_20ABEB637645698E (producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE caja ADD CONSTRAINT FK_E465F405167E8AA5 FOREIGN KEY (usuario_apertura_id) REFERENCES usuarios (id)');
        $this->addSql('ALTER TABLE caja ADD CONSTRAINT FK_E465F4054CF69F79 FOREIGN KEY (usuario_cierre_id) REFERENCES usuarios (id)');
        ...
        $this->addSql('ALTER TABLE categorias_productos ADD CONSTRAINT FK_2AA1DD383397707A FOREIGN KEY (categoria_id) REFERENCES categorias (id)');
        ...
        $this->addSql('ALTER TABLE compras ADD CONSTRAINT FK_3692E1B762F40C3D FOREIGN KEY (creador_id) REFERENCES usuarios (id)');
        ...
        $this->addSql('ALTER TABLE cotizaciones ADD CONSTRAINT FK_12CE14AE9C9C9E68 FOREIGN KEY (almacen_id) REFERENCES almacenes (id)');
        ...
        $this->addSql('ALTER TABLE movimientos_caja ADD CONSTRAINT FK_C8F6D5E32D82B651 FOREIGN KEY (caja_id) REFERENCES caja (id)');
        $this->addSql('ALTER TABLE movimientos_caja ADD CONSTRAINT FK_C8F6D5E362F40C3D FOREIGN KEY (creador_id) REFERENCES usuarios (id)');
        ...
        $this->addSql('ALTER TABLE ventas ADD CONSTRAINT FK_808D9E9C9C9E68 FOREIGN KEY (almacen_id) REFERENCES almacenes (id)');
        $this->addSql('ALTER TABLE ventas ADD CONSTRAINT FK_808D9E62F40C3D FOREIGN KEY (creador_id) REFERENCES usuarios (id)');
        ...
        $this->addSql('ALTER TABLE ventas_pagos_detalle ADD CONSTRAINT FK_18297BA63FB8380 FOREIGN KEY (pago_id) REFERENCES ventas_pagos (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cotizaciones DROP FOREIGN KEY FK_12CE14AE9C9C9E68');
        ...
        $this->addSql('ALTER TABLE ventas DROP FOREIGN KEY FK_808D9E9C9C9E68');
        $this->addSql('ALTER TABLE movimientos_caja DROP FOREIGN KEY FK_C8F6D5E32D82B651');
        ...
        $this->addSql('ALTER TABLE categorias_productos DROP FOREIGN KEY FK_2AA1DD387645698E');
        ...
        $this->addSql('ALTER TABLE caja DROP FOREIGN KEY FK_E465F405167E8AA5');
        $this->addSql('ALTER TABLE caja DROP FOREIGN KEY FK_E465F4054CF69F79');
        $this->addSql('ALTER TABLE compras DROP FOREIGN KEY FK_3692E1B762F40C3D');
        $this->addSql('ALTER TABLE cotizaciones DROP FOREIGN KEY FK_12CE14AE62F40C3D');
        $this->addSql('ALTER TABLE movimientos_caja DROP FOREIGN KEY FK_C8F6D5E362F40C3D');
        $this->addSql('ALTER TABLE ventas DROP FOREIGN KEY FK_808D9E62F40C3D');
        ...
        $this->addSql('ALTER TABLE ventas_pagos_detalle DROP FOREIGN KEY FK_18297BA63FB8380');
        ...
        $this->addSql('DROP TABLE movimientos_caja');
        ...
        $this->addSql('DROP TABLE ventas_pagos_detalle');
