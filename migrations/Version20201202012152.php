 ...
 */
final class Version20201202012152 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reparaciones ADD sena DOUBLE PRECISION DEFAULT NULL, CHANGE almacen_id almacen_id INT DEFAULT NULL, CHANGE cliente_id cliente_id INT DEFAULT NULL, CHANGE receptor_id receptor_id INT DEFAULT NULL, CHANGE tinta_c tinta_c DOUBLE PRECISION DEFAULT NULL, CHANGE tinta_m tinta_m DOUBLE PRECISION DEFAULT NULL, CHANGE tinta_y tinta_y DOUBLE PRECISION DEFAULT NULL, CHANGE tinta_cl tinta_cl DOUBLE PRECISION DEFAULT NULL, CHANGE tinta_ml tinta_ml DOUBLE PRECISION DEFAULT NULL, CHANGE tinta_bk tinta_bk DOUBLE PRECISION DEFAULT NULL, CHANGE estado estado VARCHAR(255) DEFAULT NULL, CHANGE presupuesto_inicial presupuesto_inicial DOUBLE PRECISION DEFAULT NULL, CHANGE presupuesto_final presupuesto_final DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE proveedores_productos CHANGE costo costo DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE reparaciones DROP sena, CHANGE almacen_id almacen_id INT DEFAULT NULL, CHANGE cliente_id cliente_id INT DEFAULT NULL, CHANGE receptor_id receptor_id INT DEFAULT NULL, CHANGE tinta_c tinta_c DOUBLE PRECISION DEFAULT \'NULL\', CHANGE tinta_m tinta_m DOUBLE PRECISION DEFAULT \'NULL\', CHANGE tinta_y tinta_y DOUBLE PRECISION DEFAULT \'NULL\', CHANGE tinta_cl tinta_cl DOUBLE PRECISION DEFAULT \'NULL\', CHANGE tinta_ml tinta_ml DOUBLE PRECISION DEFAULT \'NULL\', CHANGE tinta_bk tinta_bk DOUBLE PRECISION DEFAULT \'NULL\', CHANGE estado estado VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE presupuesto_inicial presupuesto_inicial DOUBLE PRECISION DEFAULT \'NULL\', CHANGE presupuesto_final presupuesto_final DOUBLE PRECISION DEFAULT \'NULL\'');
