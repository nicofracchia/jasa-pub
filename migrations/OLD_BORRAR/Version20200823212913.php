 ...
 */
final class Version20200823212913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ajustes_stock (id INT AUTO_INCREMENT NOT NULL, motivo_id INT NOT NULL, usuario_id INT NOT NULL, producto_id INT NOT NULL, fecha DATETIME NOT NULL, cantidad INT NOT NULL, observaciones VARCHAR(255) NOT NULL, stock_anterior INT NOT NULL, INDEX IDX_1477ECF5F9E584F8 (motivo_id), INDEX IDX_1477ECF5DB38439E (usuario_id), INDEX IDX_1477ECF57645698E (producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE almacenes (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, direccion VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE clientes (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellido VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, dni VARCHAR(255) NOT NULL, telefono VARCHAR(255) DEFAULT NULL, direccion VARCHAR(255) DEFAULT NULL, habilitado SMALLINT NOT NULL, eliminado SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE combos (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, porcentaje_costo DOUBLE PRECISION NOT NULL, precio_final DOUBLE PRECISION NOT NULL, descripcion LONGTEXT DEFAULT NULL, habilitado SMALLINT NOT NULL, eliminado SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE combos_productos (id INT AUTO_INCREMENT NOT NULL, id_producto_id INT NOT NULL, id_combo_id INT NOT NULL, INDEX IDX_5A68FA3F6E57A479 (id_producto_id), INDEX IDX_5A68FA3FBBBE6B76 (id_combo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cotizaciones (id INT AUTO_INCREMENT NOT NULL, id_cliente_id INT NOT NULL, fecha DATETIME NOT NULL, estado VARCHAR(255) NOT NULL, INDEX IDX_12CE14AE7BF9CE86 (id_cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cotizaciones_productos (id INT AUTO_INCREMENT NOT NULL, id_cotizacion_id INT NOT NULL, id_producto_id INT NOT NULL, INDEX IDX_E238C0068E5841CF (id_cotizacion_id), INDEX IDX_E238C0066E57A479 (id_producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE productos (id INT AUTO_INCREMENT NOT NULL, categoria_id INT NOT NULL, id_unidad_medida_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, codigo_barras VARCHAR(255) DEFAULT NULL, costo DOUBLE PRECISION NOT NULL, porcentaje_costo DOUBLE PRECISION NOT NULL, precio_final DOUBLE PRECISION NOT NULL, descripcion LONGTEXT DEFAULT NULL, habilitado SMALLINT NOT NULL, eliminado SMALLINT NOT NULL, iamgen VARCHAR(255) DEFAULT NULL, stock_actual INT NOT NULL, stock_minimo INT NOT NULL, INDEX IDX_767490E63397707A (categoria_id), INDEX IDX_767490E6E16A5625 (id_unidad_medida_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE productos_almacenes (id INT AUTO_INCREMENT NOT NULL, id_producto_id INT NOT NULL, id_almacen_id INT NOT NULL, INDEX IDX_586E72EB6E57A479 (id_producto_id), INDEX IDX_586E72EB39161EBF (id_almacen_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE proveedores (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, cuit VARCHAR(255) DEFAULT NULL, telefono VARCHAR(255) DEFAULT NULL, mail VARCHAR(255) DEFAULT NULL, direccion VARCHAR(255) DEFAULT NULL, notas LONGTEXT DEFAULT NULL, habilitado SMALLINT NOT NULL, eliminado SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE servicios (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT DEFAULT NULL, habilitado SMALLINT NOT NULL, eliminado SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuarios (id INT AUTO_INCREMENT NOT NULL, rol_id INT NOT NULL, almacen_id INT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, nombre VARCHAR(255) NOT NULL, apellido VARCHAR(255) NOT NULL, direccion VARCHAR(255) DEFAULT NULL, habilitado SMALLINT NOT NULL, eliminado SMALLINT NOT NULL, UNIQUE INDEX UNIQ_EF687F2E7927C74 (email), INDEX IDX_EF687F24BAB96C (rol_id), INDEX IDX_EF687F29C9C9E68 (almacen_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
