 ...
 */
final class Version20201202101119 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ventas_envios (id INT AUTO_INCREMENT NOT NULL, venta_id INT NOT NULL, costo_envio DOUBLE PRECISION DEFAULT NULL, costo_embalaje DOUBLE PRECISION DEFAULT NULL, codigo_seguimiento VARCHAR(255) DEFAULT NULL, INDEX IDX_B8CEF311F2A5805D (venta_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE ventas_envios ADD CONSTRAINT FK_B8CEF311F2A5805D FOREIGN KEY (venta_id) REFERENCES ventas (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE ventas_envios');
        $this->addSql('ALTER TABLE caja CHANGE usuario_apertura_id usuario_apertura_id INT DEFAULT NULL, CHANGE usuario_cierre_id usuario_cierre_id INT DEFAULT NULL, CHANGE cierre cierre DATETIME DEFAULT \'NULL\', CHANGE saldo_estimado saldo_estimado DOUBLE PRECISION DEFAULT \'NULL\', CHANGE saldo_final saldo_final DOUBLE PRECISION DEFAULT \'NULL\'');
